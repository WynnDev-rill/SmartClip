...
Metadata availability depends on the provider and platform codec support. Stream copy is limited to H.264/AAC and sync-sample start precision. Browser trim controls are a development convenience and never fake an export. The transitional FastAPI backend remains in the repository but is not called by this UI.

The next product step is **local 9:16 layout and facecam/gameplay composition** with a maintained on-device encoder.
